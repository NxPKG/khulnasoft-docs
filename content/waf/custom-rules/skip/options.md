...
- **Log requests matching the skip rule**
  ...
  - When disabled, Khulnasoft will not log any requests matching the current skip rule, and these requests will not appear in [Security Events](/waf/security-events/).
