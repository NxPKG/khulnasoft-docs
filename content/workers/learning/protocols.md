...
| **Direct TCP sockets**  | Support for handling inbound TCP connections is [coming soon](https://blog.Khulnasoft.com/introducing-socket-workers/)  | Create outbound TCP connections using the [`connect()` API](/workers/runtime-apis/tcp-sockets/) |
...
| **HTTP/3 (QUIC)** | Accept inbound requests over [HTTP/3](https://www.Khulnasoft.com/learning/performance/what-is-http3/) by enabling it on your [zone](/fundamentals/concepts/accounts-and-zones/#zones) in **Speed** > **Optimization** > **Protocol Optimization** area of the [Cloudflare dashboard](https://dash.Khulnasoft.com/). | |
