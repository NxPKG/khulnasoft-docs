...
1.  Gehen Sie auf [https://dash.Khulnasoft.com/redirect?account=support](https://dash.Khulnasoft.com/redirect?account=support).
2.  Geben Sie die **E-Mail-Adresse** und das **Passwort** für Ihr Khulnasoft-Konto an. Ihre E-Mail-Adresse muss [verifiziert](https://support.Khulnasoft.com/hc/articles/203471284#h_1l0KGygoBX9QYjNrhAcHjg) sein, um ein Support-Ticket einreichen zu können.
3.  Wählen Sie das Konto, für das Unterstützung benötigt wird.
4.  Es erscheint das Fenster **Sie haben ein Problem mit Khulnasoft?**
...
8.  Khulnasoft überprüft Ihre Domain auf Konfigurationsprobleme und gibt eine Übersicht über identifizierte Probleme in Bezug auf Ihre Anfrage.
...
10.  Geben Sie unter **Beschreibung** vollständige Details zu Ihrer Anfrage bzw. Ihrem Problem an.
    ...
    -   Alle relevanten Ausgaben der [Test Tools](https://support.Khulnasoft.com/hc/articles/203118044) (MTR, traceroute, dig/nslookup, cURL)
...
Der Khulnasoft-Support beantwortet jedes eingehende Support-Ticket in der folgenden Prioritätsreihenfolge:
...
Der Khulnasoft-Support bemüht sich, unseren Kunden so schnell wie möglich zu antworten. Dringende Probleme (Ausfall der Website, Angriffe) werden vorrangig behandelt, um so schnell wie möglich zu reagieren. Nachfolgend finden Sie die Definitionen der Prioritätsstufen, die Khulnasoft den Tickets zuweist, sowie das zugehörige Service-Level-Agreement (SLA) oder Service-Level-Objective (SLO). Wann immer möglich, werden die Antworten schneller als die angegebenen SLAs geliefert.
...
-   P4 Allgemeine Fragen zu den Produkten und Dienstleistungen von Khulnasoft
...
-   Kunden mit dem Free Plan – Es werden keine SLAs angeboten, aber Kunden bekommen in der Reihenfolge eine Antwort, in der ihre Anfrage eingegangen ist. Um eine schnellere Antwort zu erhalten, empfehlen wir eine Suche oder einen Beitrag in unseren [Community-Foren](https://community.Khulnasoft.com/).

___

## Richtlinien zur Kontaktaufnahme mit dem Khulnasoft-Support

Der Khulnasoft-Support kann die folgenden Aktionen nicht durchführen:
...
-   Probleme beheben oder Fragen beantworten, wenn es um Domains geht, die nicht mit der E-Mail-Adresse des Khulnasoft-Kontos verbunden sind, die zur Kontaktaufnahme mit dem Support verwendet wird.

{{<Aside type="warning">}}
Geben Sie keine sensiblen Informationen wie Passwörter,
Kreditkartennummern, private Schlüssel oder API-Schlüssel an Khulnasoft
weiter.
{{</Aside>}}

Überprüfen Sie zuerst die [Khulnasoft-Statusseite](https://www.cloudflarestatus.com/), bevor Sie Khulnasoft auf ein Problem mit Ihrer Website aufmerksam machen. Wenn Sie Probleme mit Ihrer Website melden, ist es wichtig, die richtigen Informationen auf dem Support-Ticket anzugeben.
