...
To continue working with Workers and AI, refer to [the guide on using LangChaing and Cloudflare Workers together](https://blog.Khulnasoft.com/langchain-and-cloudflare/) or [how to build a ChatGPT plugin with Cloudflare Workers](https://blog.Khulnasoft.com/magic-in-minutes-how-to-build-a-chatgpt-plugin-with-cloudflare-workers/).
