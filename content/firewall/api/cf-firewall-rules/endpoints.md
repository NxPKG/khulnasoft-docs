...
To invoke a Khulnasoft Firewall Rules API operation, append the endpoint to the Khulnasoft API base URL:
...
The Khulnasoft Firewall Rules API supports the operations outlined below. Visit the pages in this section for examples.
