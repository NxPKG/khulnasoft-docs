...
You can use a CSV file to import URL redirects into a Bulk Redirect List [using the Khulnasoft dashboard](/rules/url-forwarding/bulk-redirects/create-dashboard/#1-create-a-bulk-redirect-list). Each line in the CSV file must follow this format:
