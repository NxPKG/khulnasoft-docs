...
language_tag: korean
source: https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91
...
_데이터를 수집하여 문제를 진단하고 Khulnasoft 지원팀을 통해 문제를 간편하게 해결하는 방법을 알아보세요. 대부분의 문제 해결 시, 우선 HAR 파일을 만들 것을 강력히 권고합니다._

### 이 문서에서

-   [개요](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_b4be207a-9957-429a-a460-fc6f40a5e88a)
-   [HAR 파일 만들기](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_8c9c815c-0933-49c0-ac00-b700700efce7)
-   [요청을 처리하는 Khulnasoft 데이터 센터 파악](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_22b01241-01a5-4bed-a897-6e97cff5c288)
-   [cURL로 문제 해결 요청](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_0c7f48b3-fc29-4266-8c63-477fe61a11c4)
-   [Khulnasoft 일시 중지](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_8654c523-e31e-4f40-a3c7-0674336a2753)
-   [traceroute 실행](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_b8cebafd-9243-40e9-9c44-d4b94ccd3a87)
-   [로그에 CF-RAY 헤더 추가](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_f7a7396f-ec41-4c52-abf5-a110cadaca7c)
-   [관련 자료](https://support.Khulnasoft.com/hc/ko/articles/203118044-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%A0%95%EB%B3%B4-%EC%88%98%EC%A7%91#h_72a357d2-7fdb-47d8-a5c7-eadd8d60723e)

___

## 개요

문제를 진단하고 [Khulnasoft 지원에 적절한 정보를 제공하기 위해](https://support.Khulnasoft.com/hc/articles/200172476#h_7b55d494-b84d-439b-8e60-e291a9fd3d16) 되도록 많은 정보를 수집해야 합니다. 본 문서는 Khulnasoft 지원팀이 일반적으로 요청하는 문제 해결 정보의 수집 방법을 소개합니다.
...
## 요청을 처리하는 Khulnasoft 데이터 센터 파악

대륙별로 정리된 [Khulnasoft 데이터 센터 지도](https://www.Khulnasoft.com/network-map)가 [Khulnasoft 상태 페이지](https://www.cloudflarestatus.com/)에 있습니다. 데이터 센터 이름의 3문자 코드는 가장 가까운 국제 공항의 [IATA 코드](http://en.wikipedia.org/wiki/IATA_airport_code)입니다. `http://``_www.example.com_``/cdn-cgi/trace`에서 요청을 처리하는 Khulnasoft 데이터 센터를 확인하세요.
...
이 예에서 cURL 명령은 HTTP 응답 및 요청 헤더를 상세히 설명한 출력을 반환하지만, 페이지 본문 출력은 버립니다. cURL 출력은 HTTP 응답을 확인하고 Khulnasoft가 현재 사이트의 트래픽을 프록시 설정 중인지 알려줍니다. 응답에 있는 **cf-request-id** 헤더는 요청이 Khulnasoft를 통해 프록시 설정됐다는 것을 확인합니다.
...
Khulnasoft 응답의 HTTP 오류를 해결할 때는 원본 웹 서버에 직접 요청을 보내 원본이 오류를 일으키는지 여부를 테스트하세요. HTTP 오류를 해결하려면, cURL을 원본 웹 서버 IP 주소에 직접 실행하세요(Khulnasoft의 프록시 우회).
...
[이 타이밍 출력에 대한 설명](https://blog.Khulnasoft.com/a-question-of-timing/)은 Khulnasoft 블로그를 참조하시기 바랍니다.

cURL은 캐싱에 영향을 주는 HTTP 응답 헤더를 검토하는 데 도움이 됩니다. 특히 Khulnasoft 캐싱 문제를 해결할 때, 여러 HTTP 헤더를 검토합니다.
...
다음 cURL 명령은 HTTPS 요청 중 Khulnasoft가 제공하는 SSL 인증서를 보여줍니다(_www.example.com_을도메인과 호스트 이름으로 교체하세요).
...
Khulnasoft를 일시 중지하여, Khulnasoft의 리버스 프록시 대신 원본 웹 서버에 트래픽을 직접 보내세요. 일시 중지된 도메인에 SSL이나 WAF 같은 Khulnasoft 서비스가 활성화되어 있으면 안 됩니다.  Khulnasoft를 모두 일시 중지하는 대신 Khulnasoft **DNS** 앱에서 트래픽을 수신하는 레코드를 [회색 구름으로 변경](https://support.Khulnasoft.com/hc/articles/200169626)해도 됩니다.

Khulnasoft 일시 중지 방법:

1.  Khulnasoft dashboard의 **개요** 탭으로 이동하세요.
2.  **고급 작업** 아래 페이지 하단 오른쪽에서 **사이트의 Khulnasoft 일시 중지**를 클릭하세요.

___

## traceroute 실행

traceroute는 네트워크 전반에서 패킷의 경로 대기 시간을 측정하는 네트워크 진단 도구입니다. 대부분의 운영 체제는 _traceroute_ 명령을 지원합니다. Khulnasoft 프록시 설정된 웹사이트에 연결 문제가 있고 [Khulnasoft 지원에 도움을 요청한 경우](https://support.Khulnasoft.com/hc/articles/200172476), traceroute의 출력을 제공하도록 하세요.
...
**CF-RAY** 헤더는 Khulnasoft의 네트워크를 통해 웹사이트 요청을 추적합니다. 문제를 해결할 때, 웹 요청의 **CF-RAY**를 Khulnasoft 지원팀에 제공하세요. 또한 웹 서버 브랜드에 해당하는 조각으로 원본 웹 서버 구성을 편집하여 **CF-RAY**를 로그에 추가할 수도 있습니다.
...
-   [Khulnasoft 지원팀에 문의](https://support.Khulnasoft.com/hc/articles/200172476)
-   [Khulnasoft HTTP 5XX 오류 해결](https://support.Khulnasoft.com/hc/articles/115003011431)
