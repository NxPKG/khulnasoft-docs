...
Many of these limits will increase during Vectorize's [public beta](/workers/platform/betas/). Visit the [changelog](/vectorize/changelog/) or join the [`#vectorize-beta`](https://discord.Khulnasoft.com/) channel in the Cloudflare Developer Discord to keep up to date with changes.
