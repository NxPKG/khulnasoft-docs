...
![Start by setting up an IPsec profile.](/images/magic-wan/third-party/sophos-firewall/1-ipsec-profile.png)
...
![The IPsec tunnel should show up on the IPsec connections list.](/images/magic-wan/third-party/sophos-firewall/2b-ipsec-tunnel.png)
...
![Create a firewall rule with the criteria and security policies from your company](/images/magic-wan/third-party/sophos-firewall/4-firewall-rule.png)
...
2. Enter **4** to choose **Device console**, and enter the following command:
    ...
    ![Access the CLI to disable anti-replay](/images/magic-wan/third-party/sophos-firewall/5-sfos-19.png)
...
2. Enter **4** to choose **Device console**, and enter the following command:
    ...
    ![Access the CLI to configure a GRE tunnel](/images/magic-wan/third-party/sophos-firewall/1-gre-connection.png)
...
![Go to Gateways to add an XFRM interface-based route](/images/magic-wan/third-party/sophos-firewall/1-sd-wan-gateway.png)
...
![Go to SD-WAN to add the desired networks and services in the route.](/images/magic-wan/third-party/sophos-firewall/2-sd-wan-routes.png)
...
![Add a custom gateway on GRE.](/images/magic-wan/third-party/sophos-firewall/sd-wan-1-gre.png)

2. Add an SD-WAN route with the desired networks and services in the route to redirect traffic to Cloudflare.

![Add an SD-WAN route.](/images/magic-wan/third-party/sophos-firewall/2-sd-wan-routes.png)
...
![Add the IP address provided by Cloudflare to prevent the probe from being dropped by the firewall.](/images/magic-wan/third-party/sophos-firewall/2-icmp-probe-firewall.png)
...
![Configure an SD-WAN route so the ICMP reply goes back to Cloudflare via the same tunnel.](/images/magic-wan/third-party/sophos-firewall/3-icmp-probe-reply.png)
...
![If the tunnel is working, it will show up with a green status.](/images/magic-wan/third-party/sophos-firewall/2b-ipsec-tunnel.png)

The corresponding XFRM interface will also show a **Connected** status.

![The XFRM interface will also show a connected status.](/images/magic-wan/third-party/sophos-firewall/1-sd-wan-gateway.png)
...
![The GRE tunnel will show a status of Enabled when working.](/images/magic-wan/third-party/sophos-firewall/gre-status-enabled.png)

![The GRE tunnel will show a status of Enabled when working.](/images/magic-wan/third-party/sophos-firewall/gre-status-enabled-b.png)
