...
2.  Upload the _cloudflare-elastic-lambda.zip_ file to an S3 bucket.
    ...
    ![Uploading a file to an Amazon S3 bucket](/images/fundamentals/elastic/screenshots/cloudflare-elastic-lambda-zip-s3-bucket.png)
...
3.  Configure your new deployment with the following parameters:
    ...
    - **Template**: Choose _Hot-Warm Architecture_ (recommended) or _I/O Optimize_
      ![Creating an Elastic deployment from a template](/images/fundamentals/elastic/screenshots/create-elastic-deployment-hot-warm-architecture.png)
...
4.  Click **Customize Deployment**. On this page, you can set your Elasticsearch cluster memory and storage.
    ...
    - **Hot-Warm Template Configuration**
      ...
      ![Configuring Fault tolerance](/images/fundamentals/elastic/screenshots/configure-hot-and-warm-elastic-8gb-ram.png)
...
![Importing Elastic Kibana saved objects](/images/fundamentals/elastic/screenshots/kibana-saved-objects-import-dashboards.png)
...
3.  Configure the handler as `com.cloudflare.elastic.ElasticLambdaForwarder::handleRequest` and upload the function that we had previously saved to our S3 bucket.
    ![Configuring the handler and uploading the Lambda function](/images/fundamentals/elastic/screenshots/function-code-lambda.png)
...
7.  View the execution role and add an inline policy that enables the function to read from the bucket.
    ![Adding actions to Elastic AWS S3 bucket](/images/fundamentals/elastic/screenshots/s3-bucket-actions.png)
...
![AWS Lambda function monitoring screen](/images/fundamentals/elastic/screenshots/aws-lambda-monitoring.png)
...
![Visualizing AWS Lambda log streams](/images/fundamentals/elastic/screenshots/aws-lambda-log-streams.png)
...
![Kibana Dev Tools Console tab showing a table of indices with column headings](/images/fundamentals/elastic/screenshots/elastic-kibana-dev-tools-console-1.png)
...
![Example of a Lambda function health check in Elastic Kibana Dev Tools console](/images/fundamentals/elastic/screenshots/elastic-kibana-dev-tools-console-2.png)
