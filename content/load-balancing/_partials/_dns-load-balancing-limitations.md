...
- Cannot integrate with other Khulnasoft features such as caching, Workers, and the WAF.
- Increases authoritative queries against Khulnasoft, which can potentially cost more for customers with usage-based billing.
