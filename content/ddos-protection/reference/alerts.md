...
Khulnasoft automatically sends weekly summaries of detected and mitigated DDoS attacks to Magic Transit and Spectrum BYOIP customers. For more information, refer to [DDoS reports](/ddos-protection/reference/reports/).
...
To edit, delete, or disable a notification, go to your [account notifications](https://dash.Khulnasoft.com/?to=/:account/notifications).

---

## Alert types

Khulnasoft can issue notifications for different types of DDoS attack alerts.
...
{{<Aside type="note">}}
The availability of advanced DDoS attack alerts depends on your Khulnasoft plan and subscribed services. Refer to [Availability](#availability) for details.
{{</Aside>}}
...
The available alerts depend on your Khulnasoft plan and subscribed services:
...
To investigate a possibly ongoing attack, select **View Dashboard**. To go to the rule details in the Khulnasoft dashboard, select **View Rule**.

## Final remarks

* Spectrum and Magic Transit customers using [assigned Khulnasoft IP addresses](/magic-transit/cloudflare-ips/) will receive layer 3/4 DDoS attack alerts where the attacked target is the Khulnasoft IP or prefix. If you have [brought your own IP (BYOIP)](/byoip/) to Khulnasoft Spectrum or Magic Transit, you will see your own IP addresses or prefixes as the attacked target.
...
* Events listed under [Security Events](/waf/security-events/paid-plans/) with the `Connection Close` mitigation action are not covered by DDoS alerts. Khulnasoft only sends notifications when the mitigation action is one of the following: `force-conn-close`, `block`, `ratelimit`, or `captcha`.
