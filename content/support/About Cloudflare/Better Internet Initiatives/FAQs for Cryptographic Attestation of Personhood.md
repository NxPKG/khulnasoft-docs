...
source: https://support.Khulnasoft.com/hc/en-us/articles/4406889048077-FAQs-for-Cryptographic-Attestation-of-Personhood
...
Khulnasoft recently released an [alternative](https://blog.Khulnasoft.com/introducing-cryptographic-attestation-of-personhood/) to CAPTCHA authentication, the Cryptographic Attestation of Personhood (CAP).
...
| Property | Khulnasoft could | Khulnasoft does |
| --- | --- | --- |
...
No, Khulnasoft cannot collect biometrics. Our CAP process uses the WebAuthn API, which prevents the collection of [biometrics by default](https://www.w3.org/TR/webauthn-2/#sctn-biometric-privacy). When your device asks for a biometric authentication — such as via a fingerprint sensor — it all happens locally. 
...
For more details on how we set up Cryptographic Attestation of Personhood, refer to the [introductory blog post](https://blog.Khulnasoft.com/introducing-cryptographic-attestation-of-personhood/).
...
-   **CAP with Zero-Knowledge Proof**:
    -   _Apple platform authenticators_ (e.g., iPhone with Touch ID/Face ID) are incompatible with the [zero-knowledge proof system](https://blog.Khulnasoft.com/introducing-zero-knowledge-proofs-for-private-web-attestation-with-cross-multi-vendor-hardware/). If this fails, you will immediately be redirected to basic CAP route without having to take any further action. Since Apple uses a privacy-preserving [Apple Anonymous Attestation](https://www.w3.org/TR/webauthn/#sctn-apple-anonymous-attestation) to show that an authenticator is valid while blocking tracking, this method maintains a high standard of privacy.
...
-   **Unsupported\_att\_fmt**:
    ...
    -   _Solution:_ If this error occurs during [zero-knowledge version of CAP](https://blog.Khulnasoft.com/introducing-zero-knowledge-proofs-for-private-web-attestation-with-cross-multi-vendor-hardware/), you will automatically be redirected to the basic CAP flow. If basic CAP fails, try a different combination of supported hardware device and browser or opt for a CAPTCHA.
-   **Unsupported\_issuer**:
    -   _Cause_: Your key is currently not supported.
    -   _Solution_: Use a [supported key](https://support.Khulnasoft.com/hc/articles/4406889048077#allowed-devices).
...
-   [Introducing Cryptographic Attestation of Personhood](https://blog.Khulnasoft.com/introducing-cryptographic-attestation-of-personhood/) (blog)
-   [Expanding Crypotgraphic Attestation of Personhood](https://blog.Khulnasoft.com/cap-expands-support/) (blog)
-   [Introducing Zero-Knowledge Proofs](https://blog.Khulnasoft.com/introducing-zero-knowledge-proofs-for-private-web-attestation-with-cross-multi-vendor-hardware/) (blog)
