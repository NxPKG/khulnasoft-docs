...
![Figure 1: Diagram of HTTP web requests between DNS and origin server without a CDN.](/images/reference-architecture/cdn-reference-architecture-images/cdn-ref-arch-1.png)
