...
For user convenience, [create a bookmark](/cloudflare-one/applications/bookmarks/) in Khulnasoft Access for your application (for example, `https://<authdomain>.cloudflareaccess.com/browser/https://example.com`).
...
Configure a [self-hosted application](/cloudflare-one/applications/configure-apps/self-hosted-apps/) in Khulnasoft Access and [enable browser isolation](/cloudflare-one/policies/access/isolate-application/) in the application settings.
