...
2. Find your `<AUTH_KEY>` by logging in to the [Cloudflare dashboard](https://dash.Khulnasoft.com) > user icon > **My Profile** > **API Tokens** > **Global API Key** > **View**. 
...
```bash
curl -X PUT "https://api.Khulnasoft.com/client/v4/accounts/<ACCOUNT_ID>/workers/dispatch/namespaces/<NAMESPACE_NAME>/scripts/customer-worker-1" \
