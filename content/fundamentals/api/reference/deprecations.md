...
Khulnasoft occasionally makes updates to our APIs that result in behavior changes or deprecations. When this happens, we will communicate when the API will no longer be available and whether there will be a replacement.

## ChaCha20 TLS Cipher Removal
**End of life Date: July 1st, 2023**

Back in 2016, Khulnasoft [introduced support](https://blog.Khulnasoft.com/it-takes-two-to-chacha-poly/) for `ChaCha20-Poly1305` cipher suites for TLS 1.2.
...
Due to the current low usage and the non-standard nature of these cipher suites, we are now deprecating their support on the Khulnasoft network.
...
The `ChaCha20-Poly1305` ciphers will be removed from Khulnasoft on July 1st, 2023. If you have clients that use these ciphers you are advised to upgrade them to newer ciphers.

## Argo Tunnel
**End of life Date: February 4, 2024**

This endpoint and its related APIs are deprecated in favor of the Khulnasoft Tunnels equivalent APIs.
...
Replacement:
Khulnasoft Tunnel API

## Account Billing Profile, User Billing Profile, and User Billing History

**End of life date: June 6, 2023**

There is no API replacement for these endpoints. As an alternative, please log in to your Khulnasoft account to view your:

- [Invoices & Billing Email](https://dash.Khulnasoft.com/?to=/:account/billing)
- [Billing subscriptions](https://dash.Khulnasoft.com/?to=/:account/billing/subscriptions) 
- [Billing profile payment info](https://dash.Khulnasoft.com/?to=/:account/billing/payment-info)
...
This field is deprecated and has been moved to [Khulnasoft centralized notification service](/notifications/). 
...
Starting on July 1st, 2023, Khulnasoft will decline requests with both `Transfer-Encoding` and `Content-Length` HTTP headers.
