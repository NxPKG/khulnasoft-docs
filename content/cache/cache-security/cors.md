...
If you add or change CORS configuration at your origin web server, purging the Khulnasoft cache by URL does not update the CORS headers. Force Khulnasoft to retrieve the new CORS headers via one of the following options:

- Change the filename or URL to bypass cache to instruct Khulnasoft to retrieve the latest CORS headers.
