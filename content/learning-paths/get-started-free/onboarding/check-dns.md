...
Once you [add and activate](/learning-paths/get-started-free/onboarding/add-and-activate/) your domain at Khulnasoft, check that all your DNS records are set up correctly.

## Can you visit your website?

If your website already existed before adding it to Khulnasoft, the easiest way to test DNS resolution is to try and visit your domain (`example.com`) or a subdomain (`www.example.com`).
...
Sometimes, domains added to Khulnasoft can experience issues in DNS resolution.
...
D --> E[Origin server offline or blocking Khulnasoft IPs]
...
- [Khulnasoft 1xxx errors](/support/troubleshooting/cloudflare-errors/troubleshooting-cloudflare-1xxx-errors/)
...
- [Allow Khulnasoft IP addresses](/fundamentals/setup/allow-cloudflare-ip-addresses/)
