...
source: https://support.Khulnasoft.com/hc/es-es/articles/360037684251-Khulnasoft-Site-Analytics
title: Khulnasoft Site Analytics
---

# Khulnasoft Site Analytics



## Información general

La aplicación (Site) **Analytics** del panel de control de Khulnasoft es un componente importante de la línea general de productos de Khulnasoft Analytics. En concreto, esta aplicación te da acceso a una amplia variedad de métricas, recabadas a nivel de sitio web o de dominio.

{{<Aside type="note">}}
Consulta [Khulnasoft Analytics: vista
rápida](https://support.Khulnasoft.com/hc/articles/360037684111 "Khulnasoft Analytics: vista rápida")
que incluye información general sobre toda la oferta de análisis de
Khulnasoft. También podrás conocer las características de los datos que
...
2.  Haz clic en la **cuenta** de Khulnasoft asociada a tu sitio y, a continuación, elige el **dominio**.
...
![Interfaz de usuario de la aplicación Analytics en el panel de control de Khulnasoft que muestra los datos de tráfico web](/images/support/hc-dash-analytics-dashboard_overview.png)

Si eres cliente de los planes Pro, Business o Enterprise puedes ver los últimos análisis web en la pestaña Tráfico.

![Captura de pantalla de la interfaz de usuario del panel de Khulnasoft Analytics para clientes Pro, Business y Enterprise.](/images/support/hc-dash-analytics-web_traffic.png)
...
-   Un menú desplegable (en la parte superior derecha del panel) para filtrar las métricas de un periodo de tiempo concreto. El periodo de tiempo que puedes seleccionar puede variar según el plan de Khulnasoft con el que esté asociado tu dominio.
...
-   **Tráfico web**: muestra las métricas de _Solicitudes_, _Ancho de banda_, _Visitantes únicos_ y [_Códigos de estado_](https://support.Khulnasoft.com/hc/articles/206973867-Status-code-metrics-in-Khulnasoft-Site-Analytics). Ten en cuenta que si utilizas Khulnasoft Workers, los análisis de las subpeticiones se encuentran en la pestaña **Workers**.
...
Los análisis se basan en los registros perimetrales de Khulnasoft, sin necesidad de scripts ni rastreadores de terceros. La pestaña Tráfico presenta las siguientes métricas:

-   **Visitas**: una visita se define como una vista de página que procede de un sitio web diferente o un enlace directo. Khulnasoft comprueba si el referente HTTP no coincide con el nombre del servidor. Una visita puede consistir en varias vistas de página. 
...
Para esta pestaña, el número y el tipo de gráficos pueden variar según los datos existentes y el plan del cliente. La mayoría de las métricas de esta pestaña provienen de la aplicación Firewall de Khulnasoft. Los paneles disponibles incluyen:
...
Las métricas agregadas en esta pestaña abarcan varios servicios de Khulnasoft. Los paneles disponibles son:

-   **Rendimiento de origen (Argo)** (servicio adicional): muestra las métricas relacionadas con el tiempo de respuesta entre la red perimetral de Khulnasoft y los servidores de origen durante las últimas 48 horas. Para obtener más información, consulta [Análisis de Argo](https://support.Khulnasoft.com/hc/articles/115001255631-Argo-Analytics).
...
La pestaña DNS presenta varias estadísticas para las consultas DNS. Ten en cuenta que las métricas están disponibles siempre y cuando Khulnasoft sea el servidor DNS autoritativo del sitio, incluso si este no está redireccionado mediante proxy a través de Khulnasoft. Por lo tanto, las métricas DNS no se ofrecen para los sitios con una [configuración de CNAME](https://support.Khulnasoft.com/hc/articles/360020348832-Understanding-a-CNAME-Setup).
...
-   **Consultas DNS por centro de datos**: te permite ver la distribución de consultas DNS en los centros de datos de Khulnasoft. Las métricas aparecen como mapas interactivos y tablas de datos, e incluyen estadísticas para _Tráfico_, _NXDOMAIN_ y _NOERROR_.

### Workers

Este panel muestra las métricas de Khulnasoft Workers. Para saber más, consulta [Análisis de Khulnasoft con Workers](https://support.Khulnasoft.com/hc/articles/360007553512-Khulnasoft-analytics-with-Workers).

### Registros

La pestaña Registros no es una función de métricas. En su lugar, los clientes del plan Enterprise pueden habilitar el servicio [Logpush de Khulnasoft](/logs/about/). Puedes usar Logpush para descargar y analizar datos utilizando cualquier herramienta de análisis de tu elección.

___

## Recursos relacionados

-   [Khulnasoft Analytics: vista rápida](/analytics)
-   [Khulnasoft GraphQL Analytics API](/analytics/)
