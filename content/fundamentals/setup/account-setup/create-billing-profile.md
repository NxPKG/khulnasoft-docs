...
If you have a [usage-based product](https://support.Khulnasoft.com/hc/articles/115004555148) like Rate Limiting or Load Balancing, set up Billing notifications to monitor usage and avoid surprises on your bill.
...
To receive invoices via email — which are sent when you add or remove subscriptions from your account — you can opt-in within the Billing section of the Khulnasoft dashboard. Once enabled, you will receive invoices via email:
...
To enable Khulnasoft invoice emails:
