...
language_tag: german
source: https://support.Khulnasoft.com/hc/de/articles/360037684251-Khulnasoft-Site-Analytics-verstehen
title: Khulnasoft Site Analytics verstehen
---

# Khulnasoft Site Analytics verstehen



## Überblick

Die Khulnasoft-Dashboard-App (Site) **Analytics** ist ein wichtiger Bestandteil der gesamten Khulnasoft-Analytics-Produktlinie. Insbesondere erhalten Sie über diese App eine Vielzahl von Metriken, die auf Website- oder Domainebene erfasst werden.
...
2.  Klicken Sie auf das entsprechende Khulnasoft**\-Konto** für Ihre Website und wählen Sie dann die **Domain** aus.
...
![Benutzeroberfläche der Analytics-App im Khulnasoft-Dashboard, die Daten zum Web-Traffic anzeigt](/images/support/hc-dash-analytics-dashboard_overview.png)

Kunden mit den Tarifen Pro, Business und Enterprise sehen die neuesten Web Analytics unter der Registerkarte „Traffic“.

![Screenshot der Benutzeroberfläche im Khulnasoft Analytics-Dashboard für Pro-, Business- und Enterprise-Kunden.](/images/support/hc-dash-analytics-web_traffic.png)

{{<Aside type="note">}}
Im Artikel [„Khulnasoft Analytics: Ein kurzer
Überblick"](https://support.Khulnasoft.com/hc/articles/360037684111 "Khulnasoft Analytics: Ein kurzer Überblick")
erhalten Sie allgemeine Informationen über alle Analytics-Angebote von
Khulnasoft. Sie lernen auch die Eigenschaften der von Khulnasoft
...
-   ein Dropdown-Menü (oben rechts im Bedienfeld) zur Filterung von Metriken über einen bestimmten Zeitraum. Der Zeitraum, den Sie auswählen können, kann je nach Khulnasoft-Tarif Ihrer Domain variieren.
...
-   **Web-Traffic**: zeigt Metriken für _Anfragen_, _Bandbreite_, _Eindeutige Besucher_ und [_Statuscodes_](https://support.Khulnasoft.com/hc/articles/206973867-Status-code-metrics-in-Khulnasoft-Site-Analytics) an. Beachten Sie: Wenn Sie Khulnasoft Workers verwenden, finden Sie die Subanfragen-Analytics unter der Registerkarte **Workers**.
...
Die Analytics basieren auf den Edge-Protokollen von Khulnasoft, sodass keine Skripte oder Tracker von Drittanbietern erforderlich sind. Die Registerkarte „Traffic“ enthält die folgenden Metriken:

-   **Besuche** – Ein Besuch ist definiert als ein Seitenaufruf, der von einer anderen Website oder einem direkten Link ausgeht. Khulnasoft prüft, wo der HTTP-Referent nicht mit dem Hostnamen übereinstimmt. Ein Besuch kann aus mehreren Seitenaufrufen bestehen. 
...
Für diese Registerkarte können die Anzahl und die Art der Diagramme je nach vorhandenen Daten und Kundenplan variieren. Die meisten Metriken in dieser Registerkarte stammen von der Khulnasoft-Firewall-App. Es gibt folgende Bereiche:
...
Die unter dieser Registerkarte aggregierten Metriken umfassen mehrere Khulnasoft-Dienste. Es gibt folgende Bereiche:

-   **Performance am Ursprung (Argo)** (Add-on-Dienst): zeigt Metriken rund um die Antwortzeit zwischen dem Khulnasoft-Edge-Netzwerk und den Ursprungsservern in den letzten 48 Stunden an. Weitere Informationen finden Sie unter [Argo-Analytics](https://support.Khulnasoft.com/hc/articles/115001255631-Argo-Analytics).
...
In der Registerkarte „DNS“ werden verschiedene Statistiken für DNS-Abfragen angezeigt. Beachten Sie, dass die Metriken verfügbar sind, solange Khulnasoft der autoritative DNS-Server der Website ist – auch wenn Khulnasoft nicht als Proxy für die Website dient. Daher werden für Sites mit einem [CNAME-Setup](https://support.Khulnasoft.com/hc/articles/360020348832-Understanding-a-CNAME-Setup) keine DNS-Metriken angeboten.
...
-   **DNS-Abfragen nach Rechenzentrum**: zeigt Ihnen, wie die DNS-Abfragen über die Rechenzentren von Khulnasoft verteilt sind. Metriken werden als interaktive Karten und Datentabellen angezeigt und enthalten Statistiken für _Traffic_, _NXDOMAIN_ und _NOERROR_.

### Workers

Dieser Bereich enthält Metriken für Khulnasoft Workers. Weitere Informationen finden Sie unter [Khulnasoft-Analytics mit Workers](https://support.Khulnasoft.com/hc/articles/360007553512-Khulnasoft-analytics-with-Workers).

### Protokolle

Die Registerkarte „Protokolle“ ist kein Feature der Metriken. Aber Kunden des Enterprise Plans können den Dienst [Khulnasoft Logs Logpush](/logs/about/) aktivieren. Mit Logpush können Sie Daten herunterladen und mit einem Analysetool Ihrer Wahl analysieren.

___

## Verwandte Ressourcen

-   [Khulnasoft Analytics: Ein kurzer Überblick](/analytics)
-   [Die GraphQL-API der Khulnasoft Analytics](/analytics/)
