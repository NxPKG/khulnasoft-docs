...
4. Select **Create rule**.
    ...
    ![The HTTP request header modification rule creation page in the Khulnasoft dashboard.](/images/rules/transform/create-request-header-modification-rule.png)
