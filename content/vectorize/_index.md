...
{{<resource header="Developer Discord" href="https://discord.Khulnasoft.com" icon="logo-Discord">}}Connect with the Workers community on Discord to ask questions, join the `#vectorize-open-beta` channel to show what you are building, and discuss the platform with other developers.{{</resource>}}
