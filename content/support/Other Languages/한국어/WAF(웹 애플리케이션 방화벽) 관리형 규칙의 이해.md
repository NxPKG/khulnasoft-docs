...
[새 WAF](https://blog.Khulnasoft.com/new-cloudflare-waf/)로 인해 긍정 오류가 발생하는 경우 몇 가지 해결 방법이 있습니다.
...
Khulnasoft의 [WAF 변경 로그](/waf/change-log/scheduled-changes/)를 통해 **Khulnasoft 관리 규칙** 집합에 진행 중인 변경 사항을 모니터링할 수 있습니다.
