...
*   Generate a key pair directly in the dashboard (Khulnasoft will **only** save the generated public key)
...
All Khulnasoft logs are encrypted at rest. Encrypting the payload content adds a second layer of encryption for the matched values that triggered a WAF rule.
