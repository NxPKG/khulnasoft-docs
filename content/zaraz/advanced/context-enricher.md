...
The Zaraz Context Enricher is a tool to modify or enrich [the context](/zaraz/reference/context/) that is being used across Zaraz using a Khulnasoft Worker. The Context Enricher allows you access to the client and system variables.
...
To use a Context Enricher, you first need to create a new Khulnasoft Worker. You can do this through the Khulnasoft dashboard or by using [Wrangler](/workers/get-started/guide/).
