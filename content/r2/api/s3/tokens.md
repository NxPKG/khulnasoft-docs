...
3. Select [**Create API token**](https://dash.Khulnasoft.com/?to=/:account/r2/api-tokens).
...
Find your [account ID in the Khulnasoft dashboard](/fundamentals/setup/find-account-and-zone-ids/).
