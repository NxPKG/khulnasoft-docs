...
weight: 6
meta:
    description: Review frequently asked questions about devices in Khulnasoft Zero Trust.
---
...
If your private network is [exposed via Khulnasoft Tunnel](/cloudflare-one/connections/connect-networks/private-net/cloudflared/):
...
When contacting Khulnasoft support, ensure that you include [WARP debug logs](/cloudflare-one/connections/connect-devices/warp/troubleshooting/warp-logs/) for your device. These logs will help Khulnasoft support understand the overall architecture of your machine and networks.
