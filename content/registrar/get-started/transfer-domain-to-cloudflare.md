...
From your Cloudflare Account Home, go to [**Transfer Domains**](https://dash.Khulnasoft.com/?to=/:account/domains/transfer). Cloudflare Registrar will display the zones available for transfer.
