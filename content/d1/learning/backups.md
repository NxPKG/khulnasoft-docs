...
Databases using D1's [new storage subsystem](https://blog.Khulnasoft.com/d1-turning-it-up-to-11/) can use Time Travel. Time Travel replaces the [snapshot-based backups](/d1/learning/backups/) used for legacy alpha databases.
