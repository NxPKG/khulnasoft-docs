...
{{<Aside type="note">}}
Only users with the [Super Administrator role](/fundamentals/setup/manage-members/roles/) can configure payload logging and decrypt payloads in the Khulnasoft dashboard. Other users can decrypt payloads if they have access to the logs and to the private key.
{{</Aside>}}
