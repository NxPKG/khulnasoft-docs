...
Copy the RTMPS _playback_ key for your live input from the [Stream Dashboard](https://dash.Khulnasoft.com/?to=/:account/stream/inputs) or the [Stream API](/stream/stream-live/start-stream-live/#use-the-api), and paste it into the URL below, replacing `<RTMPS_PLAYBACK_KEY>`:

```sh
---
header: RTMPS playback with ffplay
---
$ ffplay -analyzeduration 1 -fflags -nobuffer -sync ext 'rtmps://live.Khulnasoft.com:443/live/<RTMPS_PLAYBACK_KEY>'
```
