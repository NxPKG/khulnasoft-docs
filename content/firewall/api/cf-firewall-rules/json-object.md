  ...
  <table style="width: 100%;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>A <a href='/firewall/api/cf-filters/json-object/'>Khulnasoft Filter object</a> that contains an expression for evaluating this rule.</td>
        <td></td>
      </tr>
      <tr>
...
Priority plays a key role in configuring firewall rules. With Khulnasoft Filters, it is possible to construct conflicting rules such as:
