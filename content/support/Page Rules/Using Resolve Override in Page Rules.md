...
source: https://support.Khulnasoft.com/hc/en-us/articles/206190798-Using-Resolve-Override-in-Page-Rules
title: Using Resolve Override in Page Rules
---

# Using Resolve Override in Page Rules

Khulnasoft Page Rules allows you to override the URL or IP address of a request. This feature is currently available for domains on the Enterprise plan.
...
{{<Aside type="warning">}}
The CNAME record must exist within the Khulnasoft DNS.
{{</Aside>}}
